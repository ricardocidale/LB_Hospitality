      ...
      >
        <ManualTable
          ...
          rows={[
            ...
            ["AGOP (Adjusted GOP)", "GOP − Management Fees (base + incentive)", "F-P-10", "Profitability"],
            ["NOI (Net Operating Income)", "AGOP − Fixed Charges (insurance + property taxes)", "F-P-11", "Profitability"],
