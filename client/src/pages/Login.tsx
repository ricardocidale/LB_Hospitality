...
import { Loader2, Building2, TrendingUp, Shield, Eye, EyeOff } from "lucide-react";
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 bg-white border-gray-200 focus:border-[#9FBCA4] focus:ring-[#9FBCA4] pr-12"
