    ...
    <div className="bg-white/80 rounded-lg p-6 border border-primary/10 shadow-[0_2px_8px_rgba(var(--primary-rgb,159,188,164),0.08)]">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">Drag sliders to model different scenarios</p>
        </div>
      </div>
          ...
          return (
            <div key={v.id} className="space-y-2">
              <div className="flex items-center justify-between">
                <label className="text-sm font-medium text-gray-700">{v.label}</label>
                <span
              ...
              <div className="flex items-center gap-3">
                <span className="text-xs text-gray-400 w-10 text-right font-mono">{v.range[0]}</span>
