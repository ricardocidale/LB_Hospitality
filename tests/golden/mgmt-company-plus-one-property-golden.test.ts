...
import {
  ...
  DEFAULT_COST_RATE_FFE, DEFAULT_COST_RATE_OTHER, DEFAULT_COST_RATE_IT, DEFAULT_COST_RATE_TAXES,
...
const H_CO_TOTAL_EXP = H_CO_PARTNER_COMP + H_CO_STAFF_COMP + H_CO_OFFICE +
  H_CO_PROF_SERV + H_CO_TECH + H_CO_TRAVEL + H_CO_IT_LIC + H_CO_MARKETING + H_CO_MISC;
