...
description: Documents the full 3,022-test automated verification system. Every financial statement, analysis, and engine calculation has dedicated tests that prove correctness without manual Excel verification.
---

# Testing & Proof System — Master Skill

## Purpose
Documents the full 3,022-test automated verification system (135 files). Every financial statement, analysis, and engine calculation has dedicated tests that prove correctness without manual Excel verification.
...
## Test Suite Map (122 files, 3,022 tests)
...
1. **All 3,022 tests must pass before any merge** — run `npm test`
