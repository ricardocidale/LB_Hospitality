...
Business simulation portal for **Hospitality Business Group**. Models a boutique hospitality management company alongside individual property SPVs with monthly and yearly financial projections. GAAP-compliant (ASC 230, ASC 360, ASC 470). 1,007 source files, ~165K lines, 3,950 tests across 170 test files. Hosted on Replit.
...
| Proof System | `.claude/skills/proof-system/SKILL.md` | 3,950 tests across 170 files, 583 golden values, verification commands |
...
## Testing & Proof System (3,950 Tests, 170 Files)
...
npm run test:summary   # All 3,950 tests, 170 files (~35s)
