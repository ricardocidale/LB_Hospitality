      ...
      >
        <ManualTable
          ...
          rows={[
            ...
            ["Cost Segregation", "IRS-approved method of accelerating depreciation by reclassifying building components (e.g., FF&E, land improvements) into shorter MACRS recovery periods (5, 7, or 15 years vs. 27.5 years). Not modeled but may reduce effective tax burden", "F-P-14", "Tax Strategy"],
