...
## Purpose
Documents the full 445-test automated verification system. Every financial statement, analysis, and engine calculation has dedicated tests that prove correctness without manual Excel verification.
...
## Test Suite Map (42 files, 445 tests)
...
| Engine | `tests/engine/` | 3 | ~71 | Property pro forma golden, company pro forma golden, formatters |
...
1. **All 445 tests must pass before any merge** — run `npm test`
