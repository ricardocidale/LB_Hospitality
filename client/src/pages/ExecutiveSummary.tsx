...
export default function ExecutiveSummary() {
  ...
  return (
    <div ref={pageRef} data-testid="executive-summary" style={styles.page}>
      ...
      <div className="bg-white rounded-xl border border-border p-4 shadow-sm mb-6 no-print">
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-sm font-semibold text-foreground mb-1">Executive Summary</h3>
