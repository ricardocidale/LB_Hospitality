export const ADMIN_CARD = "bg-white/80 backdrop-blur-xl border-primary/20 shadow-[0_8px_32px_rgba(159,188,164,0.1)]";

export const ADMIN_LINK_CARD = "group bg-white/60 backdrop-blur-sm border border-primary/15 rounded-xl p-4 flex items-center gap-4 hover:border-primary/30 hover:bg-primary/[0.03] transition-all duration-200 text-left cursor-pointer";
