...
CREATE TABLE "global_assumptions" (
	...
	"boutique_definition" jsonb DEFAULT '{"minRooms":10,"maxRooms":80,"hasFB":true,"hasEvents":true,"hasWellness":true,"minAdr":150,"maxAdr":600,"description":"Independently operated, design-forward properties with curated guest experiences, on-site F&B, event hosting, and wellness programming."}'::jsonb NOT NULL,
