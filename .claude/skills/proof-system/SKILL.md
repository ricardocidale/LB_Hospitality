---
name: proof-system
description: Automated financial proof system with 477 tests and 5 golden scenarios. Use when running verification, adding tests, debugging financial calculations, or reviewing proof coverage.
---

# Automated Financial Proof System

## Purpose
Eliminates human Excel verification. Code proves itself correct through 477 automated tests across 5 golden scenarios, input-to-output pipeline verification, and magic number detection.
...
## Maintenance
1. Run `npm test` — all 477 tests must pass
