      ...
      >
        <ManualTable
          ...
          rows={[
            ...
            ["NOI (Net Operating Income)", "GOP − Fixed Charges (property taxes)", "F-P-10", "Profitability"],
            ["ANOI (Adjusted NOI)", "NOI − Base Fee − Incentive Fee − FF&E Reserve", "F-P-11", "Profitability"],
