...
import { IconBuilding2, IconKey, IconTrendingUp, IconDollarSign, IconArrowUpRight } from "@/components/icons";
...
const typeConfig: Record<string, { icon: ReactNode; color: string; bg: string }> = {
  ...
  ramp: { icon: <IconTrendingUp className="w-4 h-4" />, color: "text-amber-600", bg: "bg-amber-100" },
  stabilization: { icon: <IconBuilding2 className="w-4 h-4" />, color: "text-emerald-600", bg: "bg-emerald-100" },
  ...
  custom: { icon: <IconBuilding2 className="w-4 h-4" />, color: "text-muted-foreground", bg: "bg-muted" },
};
