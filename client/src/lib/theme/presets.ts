...
export const PRESET_THEMES: ThemePreset[] = [
  {
    ...
    colors: [
      ...
      { rank: 1, name: "Charcoal",        hexCode: "#27272A", description: "CHART: Primary series — revenue and key metrics." },
      { rank: 2, name: "Slate",           hexCode: "#52525B", description: "CHART: Secondary series — net income and profitability." },
      { rank: 3, name: "Zinc",            hexCode: "#71717A", description: "CHART: Tertiary series — cash flow and operational metrics." },
      { rank: 4, name: "Stone",           hexCode: "#A1A1AA", description: "CHART: Quaternary series — expenses and budget." },
      { rank: 5, name: "Ash",             hexCode: "#D4D4D8", description: "CHART: Quinary series — background and comparison." },
