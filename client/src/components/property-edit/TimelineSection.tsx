      ...
      <div className="relative p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <Input type="date" value={draft.acquisitionDate} onChange={(e) => onChange("acquisitionDate", e.target.value)} className="bg-white border-primary/30 text-foreground" />
          </div>
          <div className="space-y-2">
            <Label className="flex items-center label-text text-foreground">
            ...
            <Input type="date" value={draft.operationsStartDate} onChange={(e) => onChange("operationsStartDate", e.target.value)} className="bg-white border-primary/30 text-foreground" />
          </div>
        </div>
      </div>
    </div>
