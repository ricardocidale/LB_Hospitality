      ...
      <div className="bg-muted/50 rounded-lg p-4">
        ...
        <ManualTable
          ...
          rows={[
            ...
            ["Debt Yield", "Debt Yield = NOI ÷ Loan Amount. Measures how quickly a lender recovers principal at foreclosure. Minimum 8–10% typically required. Identifies whether DSCR or LTV is the binding constraint."],
            ["Stress Test", "A matrix showing DSCR at every combination of interest rate change (in basis points) and NOI change (%). Cells turn red when DSCR falls below the minimum threshold — reveals the breaking point."],
