...
For per-component implementation details (full props, usage patterns, project-specific import paths), see `.claude/skills/marcela-ai/elevenlabs-ui-components.md`.

Upstream docs: https://github.com/elevenlabs/ui (`apps/www/content/docs/components/`).
