  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <InputField label="Annual ANOI" value={noi} onChange={setNoi} prefix="$" helpText="Adjusted NOI: NOI minus FF&E reserve — the income available to service debt" data-testid="input-dscr-noi" />
