...
- **Reynaldo User**: Default user `reynaldo.fagundes@norfolk.ai` (name: Reynaldo Fagundes, title: CTO, company: Norfolk AI, role: user). Password from `REYNALDO_PASSWORD` env secret. Server auto-seeds/resets on startup.
