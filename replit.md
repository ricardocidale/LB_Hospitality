...
npm run test:summary   # Run all 1252 tests, 1-line output on pass
npm run verify:summary # 4-phase verification, compact output
npm test               # Run all 1252 tests (full output)
...
## Top Rules
- **Calculations and correct reports are always the highest priority.** 1252-test proof system must always pass.
