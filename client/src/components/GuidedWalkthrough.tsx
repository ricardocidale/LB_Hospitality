...
function getTourSteps(firstName?: string | null) {
  ...
  return [
    ...
    { target: '[href="/company"]', title: "Step 3: General Configuration", description: "Review and adjust the company assumptions that apply across all properties — tax rates, inflation, depreciation schedules, and other defaults. Admins can also configure model defaults in the Admin panel." },
