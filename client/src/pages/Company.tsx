            ...
            <div className="relative overflow-hidden rounded-2xl shadow-lg">
              ...
              <div className="relative flex flex-wrap gap-1 p-1.5">
                <button
                  ...
                  className={`relative overflow-hidden px-4 py-2.5 text-sm font-semibold rounded-xl transition-all duration-300 ${
                    activeTab === "income" ? "text-white" : "text-white/80 hover:text-white hover:bg-white/15"
                  }`}
                >
                  {activeTab === "income" && (
                    <>
                  ...
                  <span className="relative drop-shadow-sm">Income Statement</span>
                </button>
                <button
                  onClick={() => setActiveTab("cashflow")}
                  className={`relative overflow-hidden px-4 py-2.5 text-sm font-semibold rounded-xl transition-all duration-300 ${
                    activeTab === "cashflow" ? "text-white" : "text-white/80 hover:text-white hover:bg-white/15"
                  }`}
                >
                  {activeTab === "cashflow" && (
                    <>
                  ...
                  <span className="relative drop-shadow-sm">Cash Flows</span>
                </button>
                <button
                  onClick={() => setActiveTab("balance")}
                  className={`relative overflow-hidden px-4 py-2.5 text-sm font-semibold rounded-xl transition-all duration-300 ${
                    activeTab === "balance" ? "text-white" : "text-white/80 hover:text-white hover:bg-white/15"
                  }`}
                >
                  {activeTab === "balance" && (
                    <>
                  ...
                  <span className="relative drop-shadow-sm">Balance Sheet</span>
                </button>
              </div>
            </div>
