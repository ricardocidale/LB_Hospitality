...
function getTourSteps(firstName?: string | null) {
  ...
  return [
    ...
    { target: '[href="/settings"]', title: "Step 3: General Config", description: "Review and adjust the global settings that apply across all properties — tax rates, inflation, depreciation schedules, and other defaults. These ensure consistency across your entire portfolio." },
