...
function addOverviewSlides(ctx: SlideContext, overview: OverviewExportData, projectionYears: number) {
  ...
  const capRows: any[][] = [
    [
      { text: "Capital Structure", options: { fill: { color: B.PRIMARY_HEX }, color: B.WHITE_HEX, bold: true, fontFace: "Arial", fontSize: 8 } },
      { text: "Value", options: { fill: { color: B.PRIMARY_HEX }, color: B.WHITE_HEX, bold: true, fontFace: "Arial", fontSize: 8, align: "right" as const } },
    ],
